const ATLAS = {
  ...
  "lessons": [
    ...
    },
    {
      ...
      "interviewAnswer": "INNER JOIN returns matching rows; LEFT JOIN keeps every row from the left side and fills unmatched right-side columns with NULL; FULL OUTER JOIN keeps rows from both sides. Choose based on what records must survive the join.",
      "keyPoints": [
        "Join keys",
      ...
      "followUpQuestions": [
        "INNER vs LEFT JOIN?",
        "What happens in a many-to-many join?",
        "How do NULLs behave in joins?",
        "How would you detect duplicate amplification?"
      ],
      "estimatedMinutes": 2
    },
    {
      ...
      "interviewAnswer": "GROUP BY changes the grain of the result by aggregating rows into groups. WHERE filters before aggregation; HAVING filters after aggregation.",
      "keyPoints": [
        "Row grain",
      ...
      "followUpQuestions": [
        ...
        "When would a window function be better?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Window functions compute values across related rows without collapsing them. Common examples are ROW_NUMBER, RANK, LAG, LEAD and running aggregates using OVER(PARTITION BY ... ORDER BY ...).",
      "keyPoints": [
        "Window vs GROUP BY",
    ...
    },
    {
      ...
      "interviewAnswer": "CTEs make complex SQL easier to reason about by naming intermediate results. They are often used to structure transformations before the final query.",
      "keyPoints": [
        "Readability",
        "Recursive CTE concept",
        "Optimization depends on database",
    ...
    },
    {
      ...
      "interviewAnswer": "Transactions group operations into an atomic unit with ACID guarantees. Indexes speed reads by maintaining an auxiliary search structure, but they consume storage and make writes more expensive.",
      "keyPoints": [
        "ACID",
        "Commit/rollback",
        "B-tree intuition",
    ...
    },
    {
      ...
      "interviewAnswer": "Stored procedures package database-side logic such as selection, joins and transformations. In data pipelines, orchestration tools can call these procedures and move their outputs to downstream stages.",
      "keyPoints": [
        "Database-side logic",
        "Parameters",
        "Transactions",
      ...
      "followUpQuestions": [
        ...
        "Why execute logic in the database?",
        "How would ADF call a procedure?",
        "How do you debug a failing pipeline activity?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "A vector represents an ordered set of features or a direction; a matrix represents a linear transformation or collection of vectors. The dot product measures alignment and is the core operation behind linear models, attention scores and neural layers.",
      "keyPoints": [
    ...
    },
    {
      ...
      "interviewAnswer": "Eigenvectors are directions preserved by a linear transformation up to scaling. SVD decomposes any matrix into orthogonal directions and singular values, making it useful for compression, PCA intuition and low-rank approximation.",
      "keyPoints": [
      ...
      "followUpQuestions": [
        ...
        "What does a small singular value mean?",
    ...
    },
    {
      ...
      "interviewAnswer": "A derivative measures local change; a gradient collects partial derivatives and points toward steepest increase. Backpropagation efficiently applies the chain rule through a computation graph.",
      "keyPoints": [
        "Partial derivatives",
        "Gradient direction",
        "Chain rule",
      ...
      "visualSummaries": [
        {
          "type": "flow",
          "title": "Gradient as local direction"
        }
      ],
      "followUpQuestions": [
        "Why does backprop use reverse mode?",
        "What is a Jacobian?",
        "What causes vanishing gradients?",
        "Why can gradient descent get stuck or oscillate?"
      ],
      "estimatedMinutes": 1
    },
    {
    ...
    },
    {
      ...
      "interviewAnswer": "Gradient descent updates parameters in the negative-gradient direction. Too large a learning rate can overshoot or diverge; too small a rate makes optimization painfully slow.",
      "keyPoints": [
      ...
      "status": "summary",
      "hasLab": true,
      "labGoal": "See how learning rate changes convergence on a simple quadratic.",
      "visualCount": 1,
      "visualSummaries": [
        {
          "type": "curve",
    ...
    },
    {
      ...
      "interviewAnswer": "Conditional probability updates the probability of an event given evidence. Bayes rule reverses a conditional using prior probability and likelihood, and underlies probabilistic inference and many classifiers.",
      "keyPoints": [
        "P(A|B)",
      ...
      "visualSummaries": [
        {
          "type": "concept-map",
          "title": "Probability building blocks"
        }
      ],
      "followUpQuestions": [
        "What is the difference between independence and conditional independence?",
        "Why can a good classifier have low precision on rare events?",
        "How does Naive Bayes use conditional independence?",
        "What is a prior and when should it matter?"
      ],
      "estimatedMinutes": 2
    },
    {
      ...
      "interviewAnswer": "Know when Bernoulli, Binomial, Poisson, Normal and related distributions are appropriate. The distribution is a model for the data-generating process, not merely a curve-fitting choice.",
      "keyPoints": [
        "Support",
        "Parameters",
      ...
      "followUpQuestions": [
        "When is Poisson a reasonable model?",
        "What is the relationship between Bernoulli and Binomial?",
        "Why does the Normal distribution appear so often?",
        "What distribution would you use for waiting times?"
      ],
      "estimatedMinutes": 2
    },
    {
      ...
      "interviewAnswer": "Expectation is the long-run average of a random variable; variance measures spread around the mean; covariance measures how two variables vary together, with correlation providing a normalized version.",
      "keyPoints": [
      ...
      "followUpQuestions": [
        ...
        "How does covariance connect to PCA?",
    ...
    },
    {
      ...
      "interviewAnswer": "The law of large numbers explains why sample averages stabilize around expectations. The CLT explains why normalized sums often approach a Normal distribution, enabling many confidence intervals and tests.",
      "keyPoints": [
        "Different theorems",
      ...
      "followUpQuestions": [
        "Does the CLT require the original data to be Normal?",
        "What changes when observations are dependent?",
        "Why does standard error shrink like 1/sqrt(n)?",
        "What is the difference between convergence in probability and in distribution?"
      ],
      "estimatedMinutes": 2
    },
    {
      ...
      "interviewAnswer": "A frequentist 95% confidence interval is produced by a procedure that would contain the true parameter in 95% of repeated samples. It is not literally a 95% probability statement about a fixed parameter after observing the data.",
      "keyPoints": [
        "Standard error",
      ...
      "visualSummaries": [
        {
          "type": "curve",
          "title": "Confidence interval around an estimate"
        }
      ],
      "followUpQuestions": [
        "How does sample size affect interval width?",
        "What is the difference between a confidence interval and prediction interval?",
        "When would you use a bootstrap interval?",
        "How does repeated testing affect coverage?"
      ],
      "estimatedMinutes": 2
    },
    {
      ...
      "interviewAnswer": "A p-value is the probability, assuming the null hypothesis and test assumptions are true, of seeing a result at least as extreme as the observed one. It is not the probability that the null hypothesis is true.",
      "keyPoints": [
        "Null/alternative",
        "Test statistic",
        "Type I/II errors",
      ...
      "status": "summary",
      "hasLab": true,
      "labGoal": "Compute a simple two-sample mean test and connect the statistic to the null hypothesis.",
      "visualCount": 1,
      "visualSummaries": [
        {
          "type": "curve",
          "title": "Null distribution and rejection region"
        }
      ],
      "followUpQuestions": [
        ...
        "How does multiple testing change interpretation?"
      ],
      "estimatedMinutes": 2
    },
    {
    ...
    },
    {
      ...
      "interviewAnswer": "Maximum likelihood chooses parameters that make observed data most likely. MAP adds a prior and chooses the most probable parameters after combining prior and likelihood; many regularizers can be interpreted as MAP priors.",
      "keyPoints": [
      ...
      "followUpQuestions": [
        ...
        "How does ridge regression connect to a Gaussian prior?",
        "What is the difference between MAP and posterior mean?",
        "When does the prior matter less?"
      ],
      "estimatedMinutes": 1
    },
    {
    ...
    },
    {
      ...
      "interviewAnswer": "A sampling distribution describes how an estimator would vary across repeated samples. Standard error measures that estimator uncertainty; it is not the standard deviation of the raw observations.",
      "keyPoints": [
        "Estimator variability shrinks with more information/sample size.",
        "SE and population SD answer different questions.",
        "Sampling design affects uncertainty."
      ],
      "resources": [
        "stanford-stats200",
        "openintro-stats"
      ...
      "followUpQuestions": [
        "What assumptions does Sampling Distributions & Standard Error make?",
        "How would you validate or debug Sampling Distributions & Standard Error in practice?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "The bootstrap approximates an estimator’s sampling distribution by repeatedly resampling the observed dataset with replacement. It is useful when analytic standard errors are difficult but the sample is reasonably representative.",
      "keyPoints": [
        "Resample rows with replacement.",
        "Recompute the statistic each time.",
        "Use the empirical distribution for uncertainty."
      ],
      "resources": [
        "stanford-stats200",
        "isl"
      ...
      "status": "summary",
      "hasLab": true,
      "labGoal": "Estimate uncertainty with a nonparametric bootstrap.",
      "visualCount": 1,
      "visualSummaries": [
        {
          "type": "flow",
      ...
      "followUpQuestions": [
        "What assumptions does Bootstrap & Resampling make?",
        "How would you validate or debug Bootstrap & Resampling in practice?"
      ],
      "estimatedMinutes": 2
    },
    {
      ...
      "interviewAnswer": "A permutation test builds a null distribution by shuffling labels in a way justified by exchangeability under the null. It is especially useful for transparent nonparametric testing.",
      "keyPoints": [
        "Define a statistic before shuffling.",
        "Shuffle only under a valid exchangeability assumption.",
        "p-value is the tail probability under the randomization/null procedure."
      ],
      "resources": [
        "stanford-stats200",
        "openintro-stats"
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions does Permutation & Randomization Tests make?",
        "How would you validate or debug Permutation & Randomization Tests in practice?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "When many hypotheses are tested, false positives accumulate. Family-wise methods such as Bonferroni control any false positive; FDR methods such as Benjamini–Hochberg control the expected proportion among discoveries.",
      "keyPoints": [
        "More tests → more opportunities for false positives.",
        "FWER and FDR are different guarantees.",
      ...
      "visualSummaries": [
        {
          "type": "bars",
          "title": "Why multiple testing matters"
        }
      ],
      "followUpQuestions": [
        "What assumptions does Multiple Testing & False Discovery Rate make?",
        "How would you validate or debug Multiple Testing & False Discovery Rate in practice?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Statistical significance asks whether an effect is hard to explain by noise under a null; effect size asks whether the magnitude is practically meaningful. Large samples can make tiny effects significant.",
      "keyPoints": [
        "Report magnitude and uncertainty, not p-value alone.",
        "Practical significance depends on costs/base rates.",
        "Confidence intervals communicate plausible effect ranges."
      ],
      "resources": [
        "openintro-stats",
      ...
      "followUpQuestions": [
        "What assumptions does Effect Size vs Statistical Significance make?",
        "How would you validate or debug Effect Size vs Statistical Significance in practice?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "ANOVA tests whether group means differ more than expected from within-group variability under model assumptions. A significant omnibus test does not say which groups differ, so post-hoc comparisons require care.",
      "keyPoints": [
        "Between-group vs within-group variation.",
        "Assumptions include independence and model-specific variance/error structure.",
        "Post-hoc tests need multiplicity control."
      ],
      "resources": [
        "stanford-stats200"
      ],
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions does ANOVA & Comparing Multiple Groups make?",
        "How would you validate or debug ANOVA & Comparing Multiple Groups in practice?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Chi-square tests compare observed categorical counts with counts expected under a null such as independence. They operate on counts, not percentages detached from sample size.",
      "keyPoints": [
        "Expected cell counts matter for approximation quality.",
        "Independence is a common null.",
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions does Chi-square Tests for Categorical Data make?",
        "How would you validate or debug Chi-square Tests for Categorical Data in practice?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Power is the probability of detecting an effect of a specified size when it truly exists. Sample-size planning links baseline variance/rate, significance level, desired power and minimum detectable effect.",
      "keyPoints": [
        "Power is defined relative to an alternative effect size.",
        "Smaller MDE requires more samples.",
        "Low power produces noisy, inconclusive experiments."
      ],
      "resources": [
        "openintro-stats",
        "microsoft-experimentation"
      ...
      "followUpQuestions": [
        "What assumptions does Power, Minimum Detectable Effect & Sample Size make?",
        "How would you validate or debug Power, Minimum Detectable Effect & Sample Size in practice?"
      ],
      "estimatedMinutes": 1
    },
    {
    ...
    },
    {
      ...
      "interviewAnswer": "OLTP systems optimize many small transactional reads/writes with strong consistency; OLAP systems optimize scans and aggregations over large historical datasets. Modeling and storage choices differ because workloads differ.",
      "keyPoints": [
        "Row-oriented often suits OLTP; columnar often suits analytics.",
        "Do not run heavy analytical scans on critical transactional DBs.",
        "Data freshness requirements drive architecture."
      ],
      "resources": [
        "cmu-db",
        "duckdb"
      ...
      "followUpQuestions": [
        "What assumptions does OLTP vs OLAP make?",
        "How would you validate or debug OLTP vs OLAP in practice?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "A star schema separates measurable events in fact tables from descriptive entities in dimensions. Grain must be defined first; many analytical errors come from joining tables at inconsistent grain.",
      "keyPoints": [
        "Declare fact-table grain explicitly.",
        "Dimensions describe who/what/where.",
      ...
      "followUpQuestions": [
        "What assumptions does Star Schemas, Facts & Dimensions make?",
        "How would you validate or debug Star Schemas, Facts & Dimensions in practice?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "SCD patterns define how dimension changes are represented. Type 1 overwrites history; Type 2 creates dated versions so historical facts can be analyzed with attributes valid at that time.",
      "keyPoints": [
        "Choose history semantics intentionally.",
        "Surrogate keys often support Type 2.",
        "Late-arriving changes need policy."
      ],
      "resources": [
        "dbt-docs"
      ],
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions does Slowly Changing Dimensions make?",
        "How would you validate or debug Slowly Changing Dimensions in practice?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "dbt manages SQL transformations as versioned models with dependencies, tests, documentation and incremental strategies inside the warehouse. It separates data transformation logic from extraction/loading infrastructure.",
      "keyPoints": [
        "Models form a DAG.",
        "Tests protect assumptions such as uniqueness/not-null.",
        "Incremental models need correct update keys/windows."
      ],
      "resources": [
        "dbt-docs"
      ],
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions does dbt: Transformation-as-Code make?",
        "How would you validate or debug dbt: Transformation-as-Code in practice?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Data contracts make schemas, ownership and expectations explicit; lineage shows downstream dependencies. Together they reduce silent breakage and clarify impact when producers change data.",
      "keyPoints": [
        "Schema compatibility is not enough; semantics matter.",
        "Owners and SLAs should be explicit.",
        "Metric definitions should be centralized/versioned."
      ],
      "resources": [
        "dbt-docs",
        "google-rules-ml"
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions does Data Contracts, Lineage & Semantic Consistency make?",
        "How would you validate or debug Data Contracts, Lineage & Semantic Consistency in practice?"
      ],
      "estimatedMinutes": 1
    },
    {
    ...
    },
    {
      ...
      "interviewAnswer": "Norms measure vector magnitude; distance functions measure separation; similarity functions such as cosine compare direction. The choice changes model geometry, nearest neighbors, clustering and regularization.",
      "keyPoints": [
        "L1 and L2 norms behave differently.",
        "Cosine similarity ignores absolute scale.",
        "Distance concentration becomes problematic in high dimensions."
      ],
      "resources": [
        "mit-linear-algebra",
        "3b1b-linear-algebra"
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions or limitations does Norms, Distances & Similarity have?",
        "How would you validate Norms, Distances & Similarity on a real dataset?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Least squares can be understood as projecting the target vector onto the column space of the design matrix; the residual is orthogonal to that space at the optimum.",
      "keyPoints": [
        "Projection geometry explains normal equations.",
        "Rank deficiency makes solutions non-unique without additional choices.",
        "QR/SVD are numerically preferable to explicit matrix inverse."
      ],
      "resources": [
        "mit-linear-algebra"
      ],
      ...
      "followUpQuestions": [
        "What assumptions or limitations does Orthogonality, Projections & Least Squares have?",
        "How would you validate Orthogonality, Projections & Least Squares on a real dataset?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "The Jacobian collects first derivatives of vector-valued functions; the Hessian contains second derivatives of a scalar objective and describes local curvature.",
      "keyPoints": [
        "Gradient gives first-order direction.",
        "Hessian eigenvalues describe local curvature.",
        "Second-order methods can converge quickly but are expensive in high dimensions."
      ],
      "resources": [
        "mit-linear-algebra",
        "stanford-cs229"
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions or limitations does Jacobians, Hessians & Second-order Thinking have?",
        "How would you validate Jacobians, Hessians & Second-order Thinking on a real dataset?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Mathematically equivalent formulas can behave very differently in floating point. Stable implementations avoid overflow/underflow, poor conditioning and subtractive cancellation.",
      "keyPoints": [
        "Use log-sum-exp for softmax/log-likelihoods.",
        "Avoid explicit matrix inversion when solves/decompositions are available.",
        "Scale values and inspect NaN/Inf early."
      ],
      "resources": [
        "numpy",
        "deep-learning-book"
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions or limitations does Numerical Stability: log-sum-exp, overflow & conditioning have?",
        "How would you validate Numerical Stability: log-sum-exp, overflow & conditioning on a real dataset?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "A joint distribution describes variables together; marginalization sums/integrates out variables; conditioning updates the distribution given observed information.",
      "keyPoints": [
        "Marginalize unwanted variables.",
        "Conditional distributions depend on evidence.",
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions or limitations does Joint, Marginal & Conditional Distributions have?",
        "How would you validate Joint, Marginal & Conditional Distributions on a real dataset?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Independence means the joint factorizes into marginals; conditional independence means two variables become independent after conditioning on a third set. Conditional independence is central to graphical models and causal reasoning.",
      "keyPoints": [
        "Zero correlation does not generally imply independence.",
        "Conditioning can remove or create dependence.",
        "DAG separation statements are about conditional independence."
      ],
      "resources": [
        "harvard-stat110",
        "harvard-causal-diagrams"
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions or limitations does Independence & Conditional Independence have?",
        "How would you validate Independence & Conditional Independence on a real dataset?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Monte Carlo approximates expectations or probabilities with repeated random samples. Error typically shrinks with the square root of sample count, so simulation is flexible but can be computationally expensive.",
      "keyPoints": [
        "Use simulation when analytic calculation is hard.",
        "Random seeds improve reproducibility, not statistical validity.",
        "Variance reduction can improve efficiency."
      ],
      "resources": [
        "harvard-stat110",
        "numpy"
      ...
      "status": "summary",
      "hasLab": true,
      "labGoal": "Estimate a probability with Monte Carlo simulation.",
      "visualCount": 1,
      "visualSummaries": [
        {
          "type": "flow",
      ...
      "followUpQuestions": [
        "What assumptions or limitations does Monte Carlo Simulation have?",
        "How would you validate Monte Carlo Simulation on a real dataset?"
      ],
      "estimatedMinutes": 2
    },
    {
      ...
      "interviewAnswer": "Condition on useful groups, solve within each group, then average using group probabilities. These identities are powerful for mixture distributions, debugging aggregate metrics and Bayesian reasoning.",
      "keyPoints": [
        "P(A)=sum P(A|B)P(B).",
        "E[X]=E[E[X|Y]].",
        "Stratification can explain aggregate differences."
      ],
      "resources": [
        "harvard-stat110"
      ],
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions or limitations does Law of Total Probability & Total Expectation have?",
        "How would you validate Law of Total Probability & Total Expectation on a real dataset?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Normalization reduces update anomalies by separating facts according to functional dependencies; analytical systems may deliberately denormalize for read performance.",
      "keyPoints": [
        "Normalization serves transactional integrity.",
        "Denormalization serves access patterns.",
        "Know the grain/key of every table."
      ],
      "resources": [
        "cmu-db",
        "postgres"
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions or limitations does Database Normalization: 1NF to 3NF have?",
        "How would you validate Database Normalization: 1NF to 3NF on a real dataset?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "A query optimizer chooses scans, joins and access paths based on statistics and indexes. Explain plans reveal whether a slow query is scanning too much, joining badly or missing useful indexes/partition pruning.",
      "keyPoints": [
        "Index presence does not guarantee index use.",
        "Join order/algorithm matters.",
        "Predicate pushdown and partition pruning reduce data read."
      ],
      "resources": [
        "cmu-db",
        "postgres"
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "What assumptions or limitations does Query Plans & SQL Performance have?",
        "How would you validate Query Plans & SQL Performance on a real dataset?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Isolation levels trade concurrency against anomalies such as dirty reads, non-repeatable reads and phantoms. Serializable provides the strongest familiar abstraction but may cost throughput/retries.",
      "keyPoints": [
        "ACID terms describe different guarantees.",
        "MVCC is a common implementation technique.",
        "Application invariants may require stronger handling than default isolation."
      ],
      "resources": [
        "cmu-db",
        "postgres"
      ...
      "visualSummaries": [
        {
          "type": "layers",
          "title": "Isolation spectrum"
        }
      ],
      "followUpQuestions": [
        "What assumptions or limitations does Transactions & Isolation Levels have?",
        "How would you validate Transactions & Isolation Levels on a real dataset?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Columnar formats store values by column, enabling compression and selective scans for analytics. Parquet also stores metadata/statistics that engines can use for predicate pushdown and row-group pruning.",
      "keyPoints": [
        "Columnar is ideal for scans of a subset of columns.",
        "Compression benefits from similar adjacent values.",
        "File sizing/partitioning affect performance."
      ],
      "resources": [
        "spark",
        "duckdb"
      ...
      "followUpQuestions": [
        "What assumptions or limitations does Columnar Storage, Parquet & Predicate Pushdown have?",
        "How would you validate Columnar Storage, Parquet & Predicate Pushdown on a real dataset?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "Warehouses emphasize managed structured analytics; data lakes store flexible files/objects; lakehouse approaches add table metadata, transactions and governance over object storage. The right choice depends on workload and organizational needs.",
      "keyPoints": [
        "Avoid architecture-by-buzzword.",
        "Table formats add schema/evolution/transaction semantics.",
        "Compute-storage separation changes scaling/cost."
      ],
      "resources": [
        "spark",
        "dbt-docs"
      ...
      "visualSummaries": [
        {
          "type": "layers",
          "title": "Data platform spectrum"
        }
      ],
      "followUpQuestions": [
        "What assumptions or limitations does Warehouse vs Data Lake vs Lakehouse have?",
        "How would you validate Warehouse vs Data Lake vs Lakehouse on a real dataset?"
      ],
      "estimatedMinutes": 1
    },
    {
    ...
    },
    {
      ...
      "interviewAnswer": "Sampling design determines which population the data represents. Simple random sampling gives each unit equal probability; stratification samples within known groups; cluster sampling selects groups and can increase correlation/variance.",
      "keyPoints": [
        "Sampling mechanism affects both bias and standard error.",
        "Stratification can improve precision for important subgroups.",
        "Clustered samples need clustered uncertainty."
      ],
      "resources": [
        "openintro-stats",
        "stanford-stats60"
      ...
      "visualSummaries": [],
      "followUpQuestions": [
        "When would you not use Sampling Design: Random, Stratified & Cluster Sampling?",
        "How would you validate or tune Sampling Design: Random, Stratified & Cluster Sampling?"
      ],
      "estimatedMinutes": 1
    },
    {
      ...
      "interviewAnswer": "More data does not fix a systematically unrepresentative sample. Selection and nonresponse bias occur when inclusion/response is related to the outcome or variables of interest.",
      "keyPoints": [
        "Distinguish sampling variance from systematic bias.",
        "Weighting can help only when selection is modeled with adequate information.",
        "Instrumentation and eligibility define the population actually observed."
      ],
      "resources": [
        "openintro-stats",
        "stanford-stats60"
      ...
      "followUpQuestions": [
        "When would you not use Selection, Coverage & Nonresponse Bias?",
        "How would you validate or tune Selection, Coverage & Nonresponse Bias?"
      ],
      "estimatedMinutes": 1
    },
    {
