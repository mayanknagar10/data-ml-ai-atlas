...
Python, testing, APIs and software practices that make data work reliable.

Deep-complete: **6/6** · Visual models: **12/6**

- 🔥 **Lists, Tuples, Sets & Dictionaries** — ✅ deep · 🖼 visual
- • **Iterators & Generators** — ✅ deep · 🖼 visual
- • **Decorators & Context Managers** — ✅ deep · 🖼 visual
- ⬆️ **NumPy Vectorization & Broadcasting** — ✅ deep · 🖼 visual
- ⬆️ **pandas: Merge, GroupBy, Missing Data** — ✅ deep · 🖼 visual
- ⬆️ **Testing ML / Data Code** — ✅ deep · 🖼 visual

## 02. 🧩 Data Structures, Algorithms & Complexity
