...
assert 'styles.css?v=2.5.5' in index and 'background.js?v=2.5.5' in index and 'app.js?v=2.5.5' in index, 'v2.5.5 frontend cache-busting missing'
...
assert '--progress-shell' in styles and '.header-reading-progress' in styles and 'background:var(--progress-shell)' in styles, 'solid header-integrated reading progress missing'
assert 'id="headerReadingProgress"' in index and 'class="header-reading-progress"' in index and '.reading-progress{display:none!important}' in styles, 'v2.5.5 header-integrated progress missing'
