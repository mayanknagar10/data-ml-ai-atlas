# Data Quality & Schema Evolution — Code Lab

Build a small, auditable Data Quality & Schema Evolution example, inspect the key state, and verify a correctness invariant with assertions.
