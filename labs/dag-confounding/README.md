# DAGs, Confounders & Colliders — Code Lab

Simulate a confounder and a collider, then verify that conditioning removes bias in the first graph and creates bias in the second.
