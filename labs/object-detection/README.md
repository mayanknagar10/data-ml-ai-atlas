# Object Detection: Boxes, Anchors & Modern Detectors — Code Lab

Build a small, auditable Object Detection: Boxes, Anchors & Modern Detectors example, inspect the key state, and verify a correctness invariant with assertions.
