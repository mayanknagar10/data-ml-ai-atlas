# Privacy, PII & Data Minimization — Code Lab

Build a small, auditable Privacy, PII & Data Minimization example, inspect the key state, and verify a correctness invariant with assertions.
