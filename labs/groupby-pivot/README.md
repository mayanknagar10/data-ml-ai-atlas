# GroupBy, Pivot & Cohort Analysis — Code Lab

Build grouped rate and cohort retention logic from first principles, compare with pandas, and verify grain, reconciliation, distinctness, and maturity bounds.
