# Independent Component Analysis (ICA) — Code Lab

Separate known non-Gaussian mixtures with FastICA and verify aligned source recovery, decorrelation and reconstruction.
