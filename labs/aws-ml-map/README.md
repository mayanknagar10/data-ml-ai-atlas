# Cloud Primitives for Production ML — Code Lab

Build a small, auditable Cloud Primitives for Production ML example, inspect the key state, and verify a correctness invariant with assertions.
