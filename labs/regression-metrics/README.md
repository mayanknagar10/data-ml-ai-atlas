# Regression Metrics: RMSE, MAE, MAPE & R² — Code Lab

Implement R-squared and common relative regression metrics, verify library agreement, and expose zero and scale behavior.
