# Replication & Consistency Models — Code Lab

Build a small, auditable Replication & Consistency Models example, inspect the key state, and verify a correctness invariant with assertions.
