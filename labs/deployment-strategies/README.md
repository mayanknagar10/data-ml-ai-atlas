# Canary, Blue/Green & Shadow Deployment — Code Lab

Build a small, auditable Canary, Blue/Green & Shadow Deployment example, inspect the key state, and verify a correctness invariant with assertions.
