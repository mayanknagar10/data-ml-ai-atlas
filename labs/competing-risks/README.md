# Competing Risks — Code Lab

Implement Aalen-Johansen cumulative incidence, contrast it with naive cause-specific one-minus-KM, and verify probability conservation, monotonicity, and cause-label symmetry.
