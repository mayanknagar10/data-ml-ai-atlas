# MapReduce, Shuffle & Distributed Aggregation — Code Lab

Build a small, auditable MapReduce, Shuffle & Distributed Aggregation example, inspect the key state, and verify a correctness invariant with assertions.
