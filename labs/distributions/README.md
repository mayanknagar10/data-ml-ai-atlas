# Common Probability Distributions — Code Lab

Implement the Binomial PMF, verify normalization and moments, and compare generated samples with NumPy and SciPy references.
