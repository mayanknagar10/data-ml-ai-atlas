# Popularity Bias in Recommenders — Code Lab

Build a small, auditable Popularity Bias in Recommenders example, inspect the key state, and verify a correctness invariant with assertions.
