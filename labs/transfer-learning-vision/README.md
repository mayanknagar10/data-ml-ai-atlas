# Transfer Learning & Fine-tuning in Vision — Code Lab

Build a small, auditable Transfer Learning & Fine-tuning in Vision example, inspect the key state, and verify a correctness invariant with assertions.
