# Accelerated Failure Time Models — Code Lab

Implement a right-censored Weibull AFT likelihood, fit it with SciPy, verify parameter recovery and time-unit invariance, and produce monotone survival curves.
