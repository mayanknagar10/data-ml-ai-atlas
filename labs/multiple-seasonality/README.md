# Multiple & Complex Seasonalities — Code Lab

Build a small, auditable Multiple & Complex Seasonalities example, inspect the key state, and verify a correctness invariant with assertions.
