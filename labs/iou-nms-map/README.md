# IoU, NMS & mAP for Detection — Code Lab

Build a small, auditable IoU, NMS & mAP for Detection example, inspect the key state, and verify a correctness invariant with assertions.
