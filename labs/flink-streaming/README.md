# Flink & Stateful Stream Processing — Code Lab

Build a small, auditable Flink & Stateful Stream Processing example, inspect the key state, and verify a correctness invariant with assertions.
