# Gaussian Processes — Code Lab

Build a small, auditable Gaussian Processes example, inspect the key state, and verify a correctness invariant with assertions.
