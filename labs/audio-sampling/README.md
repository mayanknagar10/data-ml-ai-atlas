# Waveforms, Sampling Rate & Aliasing — Code Lab

Build a small, auditable Waveforms, Sampling Rate & Aliasing example, inspect the key state, and verify a correctness invariant with assertions.
