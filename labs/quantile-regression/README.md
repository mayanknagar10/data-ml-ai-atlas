# Quantile Regression — Code Lab

Solve linear quantile regression as a linear program, compare with scikit-learn, and verify pinball optimality, translation equivariance, and empirical quantile behavior.
