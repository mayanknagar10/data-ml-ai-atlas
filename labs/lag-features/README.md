# Lags, Rolling Windows & Leakage — Code Lab

Build a small, auditable Lags, Rolling Windows & Leakage example, inspect the key state, and verify a correctness invariant with assertions.
