# MinHash & Jaccard Similarity — Code Lab

Build deterministic MinHash signatures, compare them with exact and library Jaccard, and test core estimator invariants.
