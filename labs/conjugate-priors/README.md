# Conjugate Priors — Code Lab

Implement Beta–Bernoulli and Gamma–Poisson conjugate updates, verify batch-order invariance, and compare posterior moments with SciPy.
