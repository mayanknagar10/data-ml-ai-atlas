# Variational Inference — Code Lab

Build a small, auditable Variational Inference example, inspect the key state, and verify a correctness invariant with assertions.
