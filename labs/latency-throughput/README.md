# Latency, Throughput & Cost Trade-offs — Code Lab

Build a small, auditable Latency, Throughput & Cost Trade-offs example, inspect the key state, and verify a correctness invariant with assertions.
