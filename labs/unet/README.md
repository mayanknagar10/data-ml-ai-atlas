# U-Net & Segmentation — Code Lab

Build a small, auditable U-Net & Segmentation example, inspect the key state, and verify a correctness invariant with assertions.
