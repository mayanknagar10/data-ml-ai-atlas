# Batch vs Streaming — Code Lab

Build a small, auditable Batch vs Streaming example, inspect the key state, and verify a correctness invariant with assertions.
