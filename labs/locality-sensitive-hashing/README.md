# Locality-Sensitive Hashing (LSH) — Code Lab

Build a banded MinHash index, derive its collision curve, and verify candidate retrieval on similar and disjoint sets.
