# Propensity Scores, Matching & Weighting — Code Lab

Estimate propensity scores, construct ATE weights, and verify improved measured balance and treatment-effect recovery.
