# Candidate Generation vs Ranking — Code Lab

Build a small, auditable Candidate Generation vs Ranking example, inspect the key state, and verify a correctness invariant with assertions.
