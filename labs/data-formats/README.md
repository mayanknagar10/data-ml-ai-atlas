# CSV vs Parquet vs Avro — Code Lab

Build a small, auditable CSV vs Parquet vs Avro example, inspect the key state, and verify a correctness invariant with assertions.
