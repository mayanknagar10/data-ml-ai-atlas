# Spark Shuffles, Partitions & Data Skew — Code Lab

Build a small, auditable Spark Shuffles, Partitions & Data Skew example, inspect the key state, and verify a correctness invariant with assertions.
