# Cox Proportional Hazards Model — Code Lab

Expose Cox partial-likelihood mechanics, fit one coefficient with Newton's method, compare SciPy optimization, and verify risk-set and survival invariants.
