# Seq2Seq & Encoder–Decoder Attention — Code Lab

Build a small, auditable Seq2Seq & Encoder–Decoder Attention example, inspect the key state, and verify a correctness invariant with assertions.
