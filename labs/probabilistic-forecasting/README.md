# Prediction Intervals & Probabilistic Forecasting — Code Lab

Build a small, auditable Prediction Intervals & Probabilistic Forecasting example, inspect the key state, and verify a correctness invariant with assertions.
