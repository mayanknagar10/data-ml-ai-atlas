# Prophet & Decomposable Forecasting — Code Lab

Build a small, auditable Prophet & Decomposable Forecasting example, inspect the key state, and verify a correctness invariant with assertions.
