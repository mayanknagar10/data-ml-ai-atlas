# Design an Internal RAG Assistant — Code Lab

Build a small, auditable Design an Internal RAG Assistant example, inspect the key state, and verify a correctness invariant with assertions.
