# GPU Memory: Parameters, Activations & KV Cache — Code Lab

Build a small, auditable GPU Memory: Parameters, Activations & KV Cache example, inspect the key state, and verify a correctness invariant with assertions.
