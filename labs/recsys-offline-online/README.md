# Offline vs Online Recommender Evaluation — Code Lab

Build a small, auditable Offline vs Online Recommender Evaluation example, inspect the key state, and verify a correctness invariant with assertions.
