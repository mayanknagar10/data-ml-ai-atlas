# Pruning & Knowledge Distillation — Code Lab

Build a small, auditable Pruning & Knowledge Distillation example, inspect the key state, and verify a correctness invariant with assertions.
