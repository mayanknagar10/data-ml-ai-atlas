# Count-Min Sketch & Heavy Hitters — Code Lab

Implement Count-Min frequency estimates, verify their one-sided behavior, and prove compatible distributed merge equivalence.
