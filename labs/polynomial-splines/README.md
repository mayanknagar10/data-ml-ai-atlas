# Polynomial Regression & Splines — Code Lab

Build a truncated cubic regression spline, use a local B-spline pipeline, and verify continuity, rank, row-order invariance, and nonlinear held-out improvement.
