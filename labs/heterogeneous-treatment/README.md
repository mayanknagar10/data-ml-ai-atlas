# Heterogeneous Treatment Effects & Uplift Modeling — Code Lab

Fit a T-learner on randomized heterogeneous effects and verify held-out CATE accuracy, ranking and calibration against known simulation truth.
