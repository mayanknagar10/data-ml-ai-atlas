# Text Classification & Encoder Fine-tuning — Code Lab

Build a small, auditable Text Classification & Encoder Fine-tuning example, inspect the key state, and verify a correctness invariant with assertions.
