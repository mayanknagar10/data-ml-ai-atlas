# Intermittent Demand Forecasting — Code Lab

Build a small, auditable Intermittent Demand Forecasting example, inspect the key state, and verify a correctness invariant with assertions.
