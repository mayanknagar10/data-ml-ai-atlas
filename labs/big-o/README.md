# Big-O Time & Space Complexity — Code Lab

Measure linear and quadratic deduplication, verify semantic equivalence, and connect observed growth to the derivation.
