# Linear Regression Assumptions & Diagnostics — Code Lab

Compute residual, leverage, studentized-residual, and Cook-distance diagnostics from first principles and verify their geometric and deletion-sensitivity invariants.
