# Implicit Feedback & Negative Sampling — Code Lab

Build a small, auditable Implicit Feedback & Negative Sampling example, inspect the key state, and verify a correctness invariant with assertions.
