# Case Study: LLM Copilot with Tools + RAG — Code Lab

Build an ACL-aware retriever and permissioned tool dispatcher, then verify grounding and authorization invariants without an external API.
