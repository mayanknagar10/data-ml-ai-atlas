# Effect Size vs Statistical Significance — Code Lab

Compute Cohen's d and Hedges' g, verify translation/scale invariance, and keep the raw effect beside the standardized result.
