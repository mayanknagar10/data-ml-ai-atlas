# Conditioning & Classifier-Free Guidance — Code Lab

Build a small, auditable Conditioning & Classifier-Free Guidance example, inspect the key state, and verify a correctness invariant with assertions.
