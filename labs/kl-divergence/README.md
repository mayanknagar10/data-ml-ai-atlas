# KL Divergence — Code Lab

Implement discrete KL with explicit support handling, compare SciPy, and verify asymmetry, nonnegativity, product additivity and cross-entropy decomposition.
