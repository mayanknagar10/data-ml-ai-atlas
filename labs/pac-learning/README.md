# PAC Learning Intuition — Code Lab

Compute finite-class PAC sample bounds, simulate consistent threshold learning, and verify monotonic dependence on epsilon, delta and class size.
