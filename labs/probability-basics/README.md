# Conditional Probability & Bayes Rule — Code Lab

Compute diagnostic Bayes probabilities from natural frequencies and verify formula/count agreement, normalization and prevalence sensitivity.
