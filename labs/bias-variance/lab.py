...
# ---- Verify it ----
for d,(bias2,var) in decomp.items():
    expected=bias2+var+noise_sd**2
    assert abs(observed[d]-expected)<0.03
assert decomp[1][0]>decomp[3][0]
assert decomp[12][1]>decomp[3][1]
