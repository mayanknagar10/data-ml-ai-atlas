# Bias–Variance Trade-off — Code Lab

Estimate bias squared, variance and noise across repeated polynomial fits and verify the squared-error decomposition empirically.
