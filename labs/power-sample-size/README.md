# Power, Minimum Detectable Effect & Sample Size — Code Lab

Compute approximate two-proportion sample size, verify monotonic design relationships, and compare an independent t-test case with statsmodels.
