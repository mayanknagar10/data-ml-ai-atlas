# Machine Learning for Forecasting — Code Lab

Build a small, auditable Machine Learning for Forecasting example, inspect the key state, and verify a correctness invariant with assertions.
