# Visual Instruction Tuning & LLaVA — Code Lab

Build a small, auditable Visual Instruction Tuning & LLaVA example, inspect the key state, and verify a correctness invariant with assertions.
