# Chi-square Tests for Categorical Data — Code Lab

Compute a Pearson independence test from scratch, verify expected margins and cell decomposition, and compare with SciPy.
