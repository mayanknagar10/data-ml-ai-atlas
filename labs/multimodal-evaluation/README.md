# Multimodal Evaluation & Visual Hallucination — Code Lab

Build a small, auditable Multimodal Evaluation & Visual Hallucination example, inspect the key state, and verify a correctness invariant with assertions.
