# Design an Experimentation Platform — Code Lab

Build a small, auditable Design an Experimentation Platform example, inspect the key state, and verify a correctness invariant with assertions.
