# Slowly Changing Dimensions — Code Lab

Build Type 2 interval insertion, including a late change, and verify non-overlap, one-current, idempotency, and temporal lookup.
