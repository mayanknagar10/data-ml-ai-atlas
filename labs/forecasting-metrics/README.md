# Forecasting Metrics & Baselines — Code Lab

Implement a multi-metric forecast scorecard, verify standard losses, and expose percentage-error and scaling behavior.
