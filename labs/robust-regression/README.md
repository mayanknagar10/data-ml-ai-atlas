# Robust Regression — Code Lab

Implement Huber iteratively reweighted least squares, compare with scikit-learn, and verify recovery, bounded response sensitivity, and row-order invariance.
