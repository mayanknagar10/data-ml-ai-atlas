# Law of Large Numbers & Central Limit Theorem — Code Lab

Simulate non-Normal sample means, verify `1/sqrt(n)` standard-error scaling and approximate CLT interval coverage with reproducible streams.
