# Jacobians, Hessians & Second-order Thinking — Code Lab

Implement central-difference Jacobian and Hessian checks, then verify JVP, VJP, symmetry and analytic curvature.
