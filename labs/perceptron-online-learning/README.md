# Perceptron & Online Learning — Code Lab

Implement standard and averaged perceptrons, compare with scikit-learn, and verify separable convergence and deterministic replay.
