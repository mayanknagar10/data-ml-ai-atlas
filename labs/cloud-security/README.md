# IAM, Secrets & Least Privilege — Code Lab

Build a small, auditable IAM, Secrets & Least Privilege example, inspect the key state, and verify a correctness invariant with assertions.
