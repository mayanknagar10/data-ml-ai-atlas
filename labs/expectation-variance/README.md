# Expectation, Variance & Covariance — Code Lab

Compute exact weighted moments and stable mergeable sample summaries, then verify covariance and total-variance identities against NumPy.
