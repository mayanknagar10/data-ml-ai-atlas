# Causal Masks vs Bidirectional Attention — Code Lab

Build a small, auditable Causal Masks vs Bidirectional Attention example, inspect the key state, and verify a correctness invariant with assertions.
