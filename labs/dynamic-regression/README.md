# Dynamic Regression / ARIMAX — Code Lab

Build a small, auditable Dynamic Regression / ARIMAX example, inspect the key state, and verify a correctness invariant with assertions.
