# Text Normalization, Stemming & Lemmatization — Code Lab

Build a small, auditable Text Normalization, Stemming & Lemmatization example, inspect the key state, and verify a correctness invariant with assertions.
