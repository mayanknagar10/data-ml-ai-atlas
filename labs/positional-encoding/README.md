# Positional Information — Code Lab

Build a small, auditable Positional Information example, inspect the key state, and verify a correctness invariant with assertions.
