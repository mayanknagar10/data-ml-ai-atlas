# Vision-Language Model Architecture: Encoder, Projector & LLM — Code Lab

Build a small, auditable Vision-Language Model Architecture: Encoder, Projector & LLM example, inspect the key state, and verify a correctness invariant with assertions.
