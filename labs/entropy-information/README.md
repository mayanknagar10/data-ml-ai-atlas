# Entropy & Information Content — Code Lab

Implement discrete entropy and self-information, compare SciPy, and verify support bounds, base conversion, deterministic limits and independent additivity.
