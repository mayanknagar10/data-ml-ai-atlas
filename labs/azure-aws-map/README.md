# Cross-Cloud Mapping: AWS, Azure & GCP — Code Lab

Build a small, auditable Cross-Cloud Mapping: AWS, Azure & GCP example, inspect the key state, and verify a correctness invariant with assertions.
