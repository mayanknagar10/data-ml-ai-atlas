# Cross-encoder / Learned Reranking — Code Lab

Expose pointwise reranking with joint relevance features, train an idiomatic logistic model, and verify candidate-ceiling, ordering and permutation invariants.
