# Learning to Rank: Pointwise, Pairwise & Listwise — Code Lab

Build a small, auditable Learning to Rank: Pointwise, Pairwise & Listwise example, inspect the key state, and verify a correctness invariant with assertions.
