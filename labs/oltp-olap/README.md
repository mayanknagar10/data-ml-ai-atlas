# OLTP vs OLAP — Code Lab

Compare row-oriented and column-oriented projections with a tiny model, then verify that both produce identical analytical results.
