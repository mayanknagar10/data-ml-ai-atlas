# Batching, Queueing & Throughput — Code Lab

Build a small, auditable Batching, Queueing & Throughput example, inspect the key state, and verify a correctness invariant with assertions.
