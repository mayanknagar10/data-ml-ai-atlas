# NLP Generation Metrics: BLEU, ROUGE & Beyond — Code Lab

Build a small, auditable NLP Generation Metrics: BLEU, ROUGE & Beyond example, inspect the key state, and verify a correctness invariant with assertions.
