# Bayesian Updating: Prior, Likelihood & Posterior — Code Lab

Build a grid posterior for a Bernoulli rate, verify it against the analytic Beta posterior, and test normalization and sequential coherence.
