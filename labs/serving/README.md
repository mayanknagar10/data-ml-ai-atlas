# Batch vs Online Model Serving — Code Lab

Build a small, auditable Batch vs Online Model Serving example, inspect the key state, and verify a correctness invariant with assertions.
