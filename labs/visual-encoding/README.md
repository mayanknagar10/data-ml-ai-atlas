# Choosing the Right Statistical Visualization — Code Lab

Build a semantic chart-spec validator, reject misleading field/mark combinations, and render a verified bar chart with matplotlib.
