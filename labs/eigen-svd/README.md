# Eigenvalues, Eigenvectors & SVD — Code Lab

Implement dominant-eigenvector power iteration, then verify SVD reconstruction, orthogonality, sign-invariant eigen behavior and optimal rank-one error.
