# Hidden Markov Models — Code Lab

Build a small, auditable Hidden Markov Models example, inspect the key state, and verify a correctness invariant with assertions.
