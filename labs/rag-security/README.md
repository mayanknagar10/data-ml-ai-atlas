# RAG Security & Access Control — Code Lab

Build a small, auditable RAG Security & Access Control example, inspect the key state, and verify a correctness invariant with assertions.
