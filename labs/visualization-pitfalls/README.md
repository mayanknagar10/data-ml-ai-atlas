# Misleading Charts & Visualization Pitfalls — Code Lab

Implement semantic integrity checks for baselines, time order, denominator stability, and area encoding, then verify detection on bad chart specs.
