# Mutual Information — Code Lab

Implement mutual information from a joint table, compare scikit-learn, and verify symmetry, independence, deterministic information and relabeling invariance.
