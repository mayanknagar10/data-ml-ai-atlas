# HNSW Intuition & Tuning — Code Lab

Implement bounded best-first proximity-graph search, compare it with greedy and exact search, and verify that exhaustive exploration recovers exact neighbors on a connected graph.
