# Graph Attention Networks (GAT) — Code Lab

Build a small, auditable Graph Attention Networks (GAT) example, inspect the key state, and verify a correctness invariant with assertions.
