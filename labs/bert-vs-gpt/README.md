# BERT vs GPT-style Models — Code Lab

Build a small, auditable BERT vs GPT-style Models example, inspect the key state, and verify a correctness invariant with assertions.
