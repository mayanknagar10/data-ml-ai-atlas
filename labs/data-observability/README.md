# Data Observability: Freshness, Volume, Schema & Distribution — Code Lab

Build a small, auditable Data Observability: Freshness, Volume, Schema & Distribution example, inspect the key state, and verify a correctness invariant with assertions.
