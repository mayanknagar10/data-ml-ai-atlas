# Numerical Stability: log-sum-exp, overflow & conditioning — Code Lab

Implement stable log-sum-exp, softmax and compensated summation, then verify extreme-value invariants and high-precision agreement.
