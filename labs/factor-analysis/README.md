# Factor Analysis — Code Lab

Simulate a factor model, fit FactorAnalysis, and verify uniqueness, covariance fit and held-out likelihood against an independence model.
