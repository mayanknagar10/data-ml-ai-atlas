# CAP Theorem Without the Myth — Code Lab

Build a small, auditable CAP Theorem Without the Myth example, inspect the key state, and verify a correctness invariant with assertions.
