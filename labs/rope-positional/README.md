# RoPE & Modern Positional Encoding — Code Lab

Build a small, auditable RoPE & Modern Positional Encoding example, inspect the key state, and verify a correctness invariant with assertions.
