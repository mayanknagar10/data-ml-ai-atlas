# CycleGAN & Unpaired Translation — Code Lab

Build a small, auditable CycleGAN & Unpaired Translation example, inspect the key state, and verify a correctness invariant with assertions.
