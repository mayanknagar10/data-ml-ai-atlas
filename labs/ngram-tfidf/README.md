# Bag-of-Words, n-grams & TF-IDF — Code Lab

Build a small, auditable Bag-of-Words, n-grams & TF-IDF example, inspect the key state, and verify a correctness invariant with assertions.
