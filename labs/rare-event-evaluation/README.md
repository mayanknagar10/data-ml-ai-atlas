# Rare-event Evaluation & Alert Thresholds — Code Lab

Implement rare-event counts, top-k metrics, average precision, and cost-sensitive threshold selection, then verify against scikit-learn and imbalance invariants.
