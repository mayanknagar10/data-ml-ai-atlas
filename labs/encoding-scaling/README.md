# Scaling & Encoding Features — Code Lab

Build a typed numeric and categorical transformer, verify training-only statistics, and test stable unseen-category behavior.
