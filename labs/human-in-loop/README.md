# Human-in-the-Loop & Safe Fallbacks — Code Lab

Build a small, auditable Human-in-the-Loop & Safe Fallbacks example, inspect the key state, and verify a correctness invariant with assertions.
