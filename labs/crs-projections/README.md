# Coordinate Reference Systems & Projections — Code Lab

Implement spherical Mercator forward and inverse transforms, compare with pyproj, and quantify latitude-dependent scale distortion.
