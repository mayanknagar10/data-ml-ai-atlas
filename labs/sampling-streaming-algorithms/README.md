# Sampling & Streaming Algorithms — Code Lab

Build reservoir sampling and count-min sketch, then verify size, reproducibility, no-underestimation, merge compatibility, and approximate uniformity.
