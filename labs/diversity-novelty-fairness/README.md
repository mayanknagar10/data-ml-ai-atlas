# Diversity, Novelty, Coverage & Fairness in Recommenders — Code Lab

Build a small, auditable Diversity, Novelty, Coverage & Fairness in Recommenders example, inspect the key state, and verify a correctness invariant with assertions.
