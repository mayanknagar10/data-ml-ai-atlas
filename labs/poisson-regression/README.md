# Poisson & Count Regression — Code Lab

Fit an exposure-offset Poisson model with Newton updates, compare with scikit-learn's weighted-rate formulation, and verify rate, exposure, likelihood, and row-order invariants.
