# Consensus & Leader Election — Code Lab

Build a small, auditable Consensus & Leader Election example, inspect the key state, and verify a correctness invariant with assertions.
