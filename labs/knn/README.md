# k-Nearest Neighbors — Code Lab

Implement distance-weighted KNN classification, compare it with scikit-learn, and verify voting, self-neighbor and scaling behavior.
