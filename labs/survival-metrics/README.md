# Survival Model Evaluation — Code Lab

Implement comparable-pair concordance and an IPCW horizon Brier score, use scikit-learn on correctly defined horizon labels, and verify orientation and censoring behavior.
