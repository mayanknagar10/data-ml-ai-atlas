# Actor-Critic & Advantage Estimation — Code Lab

Build a small, auditable Actor-Critic & Advantage Estimation example, inspect the key state, and verify a correctness invariant with assertions.
