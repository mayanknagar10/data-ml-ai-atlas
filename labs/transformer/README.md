# Transformer Architecture — Code Lab

Build a small, auditable Transformer Architecture example, inspect the key state, and verify a correctness invariant with assertions.
