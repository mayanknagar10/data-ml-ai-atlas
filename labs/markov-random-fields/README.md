# Markov Random Fields & Factor Graphs — Code Lab

Build a small, auditable Markov Random Fields & Factor Graphs example, inspect the key state, and verify a correctness invariant with assertions.
