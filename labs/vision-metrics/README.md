# PSNR, SSIM, LPIPS & FID — Code Lab

Build a small, auditable PSNR, SSIM, LPIPS & FID example, inspect the key state, and verify a correctness invariant with assertions.
