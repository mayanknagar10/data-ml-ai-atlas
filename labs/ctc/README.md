# Connectionist Temporal Classification (CTC) — Code Lab

Build a small, auditable Connectionist Temporal Classification (CTC) example, inspect the key state, and verify a correctness invariant with assertions.
