# Time-Series Foundation Models — Code Lab

Build a small, auditable Time-Series Foundation Models example, inspect the key state, and verify a correctness invariant with assertions.
