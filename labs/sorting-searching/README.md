# Sorting, Binary Search & Selection — Code Lab

Build stable merge sort and lower-bound binary search, then verify ordering, permutation, stability, duplicates, and boundary invariants.
