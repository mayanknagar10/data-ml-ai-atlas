# LLM Training Lifecycle: Pretraining → SFT → Preference Tuning — Code Lab

Build a small, auditable LLM Training Lifecycle: Pretraining → SFT → Preference Tuning example, inspect the key state, and verify a correctness invariant with assertions.
