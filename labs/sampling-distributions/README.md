# Sampling Distributions & Standard Error — Code Lab

Simulate a sampling distribution, verify the analytic SE, and show how cluster dependence invalidates a row-level iid calculation.
