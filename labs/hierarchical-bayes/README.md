# Hierarchical / Multilevel Models — Code Lab

Implement Normal hierarchical shrinkage with known hyperparameters, verify limiting behavior, and express the equivalent PyMC model.
