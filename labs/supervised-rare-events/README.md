# Supervised Rare-event Modeling — Code Lab

Demonstrate probability distortion from negative subsampling, apply prior-log-odds correction, and verify ranking, prevalence, and cost-policy invariants.
