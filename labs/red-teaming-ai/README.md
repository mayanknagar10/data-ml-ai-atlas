# AI Red Teaming & Adversarial Testing — Code Lab

Build a small, auditable AI Red Teaming & Adversarial Testing example, inspect the key state, and verify a correctness invariant with assertions.
