# Missing Values & Outliers — Code Lab

Implement training-only median imputation with indicators, verify pipeline parity, and prove validation extremes cannot change fitted values.
