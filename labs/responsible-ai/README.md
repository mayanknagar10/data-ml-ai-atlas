# Responsible AI: Risk, Impact & Governance — Code Lab

Build a small, auditable Responsible AI: Risk, Impact & Governance example, inspect the key state, and verify a correctness invariant with assertions.
