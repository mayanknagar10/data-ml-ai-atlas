# Segmentation Metrics: IoU, Dice & Pixel Accuracy — Code Lab

Build a small, auditable Segmentation Metrics: IoU, Dice & Pixel Accuracy example, inspect the key state, and verify a correctness invariant with assertions.
