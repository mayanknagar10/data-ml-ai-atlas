# Design a Recommendation System — Code Lab

Build a small, auditable Design a Recommendation System example, inspect the key state, and verify a correctness invariant with assertions.
