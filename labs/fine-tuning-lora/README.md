# Fine-tuning, LoRA & Quantization — Code Lab

Build a small, auditable Fine-tuning, LoRA & Quantization example, inspect the key state, and verify a correctness invariant with assertions.
