# Support Vector Machines — Code Lab

Train a linear soft-margin classifier with hinge-loss subgradients, compare with LinearSVC, and verify margin and scaling behavior.
