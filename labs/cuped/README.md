# Variance Reduction & CUPED — Code Lab

Implement CUPED adjustment, compare it with regression adjustment, and verify effect unbiasedness plus variance reduction over repeated randomized experiments.
