# Joint, Marginal & Conditional Distributions — Code Lab

Normalize and query a discrete joint table, verifying marginals, conditionals, reconstruction, expectations and dependence.
