# ANOVA & Comparing Multiple Groups — Code Lab

Compute one-way ANOVA from first principles, verify the sums-of-squares identity and translation invariance, and compare F with SciPy.
