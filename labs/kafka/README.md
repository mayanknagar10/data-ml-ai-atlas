# Kafka Fundamentals — Code Lab

Build a small, auditable Kafka Fundamentals example, inspect the key state, and verify a correctness invariant with assertions.
