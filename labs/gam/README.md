# Generalized Additive Models (GAMs) — Code Lab

Build a centered additive spline design, fit penalized components, compare with an idiomatic scikit-learn pipeline, and verify additivity, permutation, and nonlinear generalization.
