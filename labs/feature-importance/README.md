# Feature Importance & Explainability — Code Lab

Compare tree impurity and held-out permutation importance, verify repeat behavior, and identify signal over independent noise.
