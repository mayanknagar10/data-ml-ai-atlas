# Synthetic Control — Code Lab

Fit simplex-constrained donor weights on pretreatment outcomes and verify recovery of a known post-treatment counterfactual gap.
