# Distributed Training: Data & Model Parallelism — Code Lab

Build a small, auditable Distributed Training: Data & Model Parallelism example, inspect the key state, and verify a correctness invariant with assertions.
