# Speech & Audio Transformers: Spectrograms and ASR — Code Lab

Build a small, auditable Speech & Audio Transformers: Spectrograms and ASR example, inspect the key state, and verify a correctness invariant with assertions.
