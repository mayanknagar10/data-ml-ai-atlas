# Bias & Fairness in ML — Code Lab

Build a small, auditable Bias & Fairness in ML example, inspect the key state, and verify a correctness invariant with assertions.
