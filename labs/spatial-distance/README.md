# Geodesic Distance & Spatial kNN — Code Lab

Implement haversine distance, compare spherical and ellipsoidal results, and verify spherical nearest-neighbor retrieval.
