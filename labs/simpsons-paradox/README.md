# Simpson’s Paradox & Aggregation Bias — Code Lab

Construct a Simpson reversal, verify weighted aggregation, and standardize both treatments to a common severity distribution.
