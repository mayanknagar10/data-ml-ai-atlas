# Decision Thresholds & Cost-sensitive Classification — Code Lab

Select a cost-aware threshold on validation scores, lock it, and verify utility and independent test evaluation.
