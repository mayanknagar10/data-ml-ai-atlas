# Experiment Tracking — Code Lab

Build a small, auditable Experiment Tracking example, inspect the key state, and verify a correctness invariant with assertions.
