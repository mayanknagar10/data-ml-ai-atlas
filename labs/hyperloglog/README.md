# HyperLogLog & Distinct Counting — Code Lab

Implement a 64-bit HyperLogLog with small-range correction, then verify duplicates, accuracy and max-merge semantics.
