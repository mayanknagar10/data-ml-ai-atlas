# Super-resolution & Reconstruction — Code Lab

Build a small, auditable Super-resolution & Reconstruction example, inspect the key state, and verify a correctness invariant with assertions.
