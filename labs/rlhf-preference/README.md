# RLHF, Reward Models & Preference Optimization — Code Lab

Build a small, auditable RLHF, Reward Models & Preference Optimization example, inspect the key state, and verify a correctness invariant with assertions.
