# Spatial Cross-Validation & Geographic Leakage — Code Lab

Simulate a spatial field and demonstrate why random folds can look better than leave-region-out validation.
