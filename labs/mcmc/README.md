# MCMC & Posterior Sampling — Code Lab

Build random-walk Metropolis for a Beta target, verify moments and multiple-chain agreement, and quantify acceptance versus autocorrelation.
