# Case Study: Graph-based Matching & Recommendation — Code Lab

Score a toy reviewer–paper graph and solve a conflict- and capacity-constrained assignment with verified invariants.
