# Message Passing in GNNs — Code Lab

Build a small, auditable Message Passing in GNNs example, inspect the key state, and verify a correctness invariant with assertions.
