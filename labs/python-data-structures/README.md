# Lists, Tuples, Sets & Dictionaries — Code Lab

Compare list, deque, set, and dictionary semantics with assertions for ordering, uniqueness, hashing, and queue behavior.
