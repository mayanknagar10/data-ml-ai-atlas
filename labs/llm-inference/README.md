# LLM Inference: Temperature, Top-p, KV Cache — Code Lab

Build a small, auditable LLM Inference: Temperature, Top-p, KV Cache example, inspect the key state, and verify a correctness invariant with assertions.
