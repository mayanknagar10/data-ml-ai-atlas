# Graph-level Prediction & Pooling — Code Lab

Build a small, auditable Graph-level Prediction & Pooling example, inspect the key state, and verify a correctness invariant with assertions.
