# Debugging a Model That Will Not Learn — Code Lab

Build a small, auditable Debugging a Model That Will Not Learn example, inspect the key state, and verify a correctness invariant with assertions.
