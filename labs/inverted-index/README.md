# Inverted Index & Text Retrieval Pipeline — Code Lab

Build a positional inverted index, execute AND and phrase queries, compare with scikit-learn term counts, and verify ordering and analyzer invariants.
