# Empirical Risk Minimization — Code Lab

Fit polynomial ERM solutions, compare scikit-learn, and verify that minimum empirical risk can generalize worse than validation-selected capacity.
