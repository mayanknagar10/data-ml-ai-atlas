# Training–Serving Skew — Code Lab

Build a small, auditable Training–Serving Skew example, inspect the key state, and verify a correctness invariant with assertions.
