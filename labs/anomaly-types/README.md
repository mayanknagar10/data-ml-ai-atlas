# Point, Contextual & Collective Anomalies — Code Lab

Build robust contextual and collective anomaly scores, compare with standardized residuals, and verify context, translation, and burst-detection invariants.
