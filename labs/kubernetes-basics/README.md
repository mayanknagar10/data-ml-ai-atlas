# Kubernetes for ML Services — Code Lab

Build a small, auditable Kubernetes for ML Services example, inspect the key state, and verify a correctness invariant with assertions.
