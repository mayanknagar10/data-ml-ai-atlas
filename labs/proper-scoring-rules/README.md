# Proper Scoring Rules: Log Loss & Brier Score — Code Lab

Build a small, auditable Proper Scoring Rules: Log Loss & Brier Score example, inspect the key state, and verify a correctness invariant with assertions.
