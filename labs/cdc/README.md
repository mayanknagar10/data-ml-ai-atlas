# Change Data Capture (CDC) — Code Lab

Build a small, auditable Change Data Capture (CDC) example, inspect the key state, and verify a correctness invariant with assertions.
