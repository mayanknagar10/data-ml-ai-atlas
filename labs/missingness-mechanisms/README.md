# Missingness: MCAR, MAR & MNAR — Code Lab

Simulate MCAR and covariate-dependent missingness, quantify complete-case bias, and verify an observed-stratum adjustment under its assumptions.
