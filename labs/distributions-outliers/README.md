# Distributions, Skewness & Outliers — Code Lab

Compute classical and robust distribution summaries, flag—not delete—unusual values, and verify translation/scale behavior against NumPy.
