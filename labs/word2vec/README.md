# Word2Vec: Skip-gram & CBOW — Code Lab

Build a small, auditable Word2Vec: Skip-gram & CBOW example, inspect the key state, and verify a correctness invariant with assertions.
