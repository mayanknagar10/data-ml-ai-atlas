# Permutation Importance, PDP & SHAP — Code Lab

Compute exact two-feature Shapley values, verify axioms for an interaction model, and contrast local allocation with global permutation reliance.
