# Cold Start in Recommender Systems — Code Lab

Build a small, auditable Cold Start in Recommender Systems example, inspect the key state, and verify a correctness invariant with assertions.
