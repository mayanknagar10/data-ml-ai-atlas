# Event Time, Processing Time & Watermarks — Code Lab

Build a small, auditable Event Time, Processing Time & Watermarks example, inspect the key state, and verify a correctness invariant with assertions.
