# PPO & Stable Policy Optimization — Code Lab

Build a small, auditable PPO & Stable Policy Optimization example, inspect the key state, and verify a correctness invariant with assertions.
