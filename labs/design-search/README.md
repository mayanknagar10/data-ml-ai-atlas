# Design a Search / Retrieval System — Code Lab

Build a small, auditable Design a Search / Retrieval System example, inspect the key state, and verify a correctness invariant with assertions.
