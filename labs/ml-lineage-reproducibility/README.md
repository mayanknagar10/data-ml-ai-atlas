# Data, Model & Experiment Lineage — Code Lab

Build a small, auditable Data, Model & Experiment Lineage example, inspect the key state, and verify a correctness invariant with assertions.
