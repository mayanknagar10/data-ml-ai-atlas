# Case Study: Scientific 3D Reconstruction / Super-resolution — Code Lab

Simulate a one-dimensional reconstruction problem and compare apparent sharpness with measurement consistency.
