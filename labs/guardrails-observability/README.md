# Guardrails, Policy Checks & AI Observability — Code Lab

Build a small, auditable Guardrails, Policy Checks & AI Observability example, inspect the key state, and verify a correctness invariant with assertions.
