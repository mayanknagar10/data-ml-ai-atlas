# Sequential Testing, Peeking & Early Stopping — Code Lab

Simulate false-positive inflation from naive peeking and verify family-wise control from a planned Bonferroni group-sequential design.
