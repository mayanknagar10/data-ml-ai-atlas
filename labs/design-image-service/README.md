# Design an Image Reconstruction Service — Code Lab

Build a small, auditable Design an Image Reconstruction Service example, inspect the key state, and verify a correctness invariant with assertions.
