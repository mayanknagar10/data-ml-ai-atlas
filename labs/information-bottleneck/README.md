# Information Bottleneck & Representation Learning — Code Lab

Enumerate deterministic discrete bottlenecks, trace the rate-relevance frontier, and verify sufficiency, compression and data-processing invariants.
