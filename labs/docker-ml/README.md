# Dockerizing an ML Inference Service — Code Lab

Build a small, auditable Dockerizing an ML Inference Service example, inspect the key state, and verify a correctness invariant with assertions.
