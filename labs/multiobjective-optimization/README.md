# Multi-objective Optimization & Pareto Trade-offs — Code Lab

Implement nondominated filtering and two-dimensional hypervolume, use SciPy for an epsilon-constraint sweep, and verify known fronts plus invariants.
