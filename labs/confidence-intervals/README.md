# Confidence Intervals — Code Lab

Verify long-run coverage of a t interval and show why an observed confidence interval is not a posterior probability statement.
