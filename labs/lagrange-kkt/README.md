# Lagrange Multipliers, Duality & KKT Conditions — Code Lab

Compute and verify the KKT certificate for a binding convex inequality, then compare the candidate with a constrained SciPy solve.
