# Graph ML Fundamentals — Code Lab

Build a small, auditable Graph ML Fundamentals example, inspect the key state, and verify a correctness invariant with assertions.
