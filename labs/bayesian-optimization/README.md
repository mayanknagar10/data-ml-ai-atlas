# Bayesian Optimization for Expensive Objectives — Code Lab

Implement a one-dimensional Gaussian-process posterior and expected-improvement policy, compare with scikit-learn, and verify uncertainty plus regret behavior.
