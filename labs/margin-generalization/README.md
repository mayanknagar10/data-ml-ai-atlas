# Margins & Generalization — Code Lab

Solve a hard-margin linear SVM primal, compare scikit-learn, and verify constraints, support points, decision agreement and geometric scale invariance.
