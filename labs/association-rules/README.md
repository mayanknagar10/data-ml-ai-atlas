# Frequent Itemsets & Association Rules — Code Lab

Implement Apriori and association-rule scoring, then verify downward closure, metric identities, and transaction-order invariance.
