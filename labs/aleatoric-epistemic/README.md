# Aleatoric vs Epistemic Uncertainty — Code Lab

Build a small, auditable Aleatoric vs Epistemic Uncertainty example, inspect the key state, and verify a correctness invariant with assertions.
