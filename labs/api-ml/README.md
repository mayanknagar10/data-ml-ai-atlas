# APIs around ML Models — Code Lab

Build a small, auditable APIs around ML Models example, inspect the key state, and verify a correctness invariant with assertions.
