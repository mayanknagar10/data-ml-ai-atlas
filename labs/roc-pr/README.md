# ROC-AUC vs PR-AUC — Code Lab

Build ROC and precision-recall points from ranked scores, verify standard areas, and demonstrate invariance and prevalence behavior.
