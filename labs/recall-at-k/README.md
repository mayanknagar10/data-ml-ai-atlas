# Recall@K & Ranking Evaluation — Code Lab

Build a small, auditable Recall@K & Ranking Evaluation example, inspect the key state, and verify a correctness invariant with assertions.
