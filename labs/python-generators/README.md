# Iterators & Generators — Code Lab

Build a bounded batching generator, use itertools for composition, and verify ordering, tail handling, and one-pass exhaustion.
