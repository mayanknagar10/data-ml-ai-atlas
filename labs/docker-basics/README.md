# Docker Images & Containers — Code Lab

Build a small, auditable Docker Images & Containers example, inspect the key state, and verify a correctness invariant with assertions.
