# Generalization Under Distribution Shift — Code Lab

Estimate target risk under simulated covariate shift, compare density-ratio weighting, and use a domain classifier as an unlabeled drift diagnostic.
