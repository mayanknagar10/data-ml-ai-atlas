# Interactions & Domain Feature Engineering — Code Lab

Construct quadratic and interaction features manually, verify library output, and test their predictive value against an additive baseline.
