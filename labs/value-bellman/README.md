# Value Functions & the Bellman Equation — Code Lab

Build a small, auditable Value Functions & the Bellman Equation example, inspect the key state, and verify a correctness invariant with assertions.
