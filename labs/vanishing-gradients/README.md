# Vanishing / Exploding Gradients — Code Lab

Build a small, auditable Vanishing / Exploding Gradients example, inspect the key state, and verify a correctness invariant with assertions.
