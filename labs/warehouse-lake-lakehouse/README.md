# Warehouse vs Data Lake vs Lakehouse — Code Lab

Model an immutable-file table snapshot, verify atomic pointer publication and rollback, and show why directory listing is not a consistent table view.
