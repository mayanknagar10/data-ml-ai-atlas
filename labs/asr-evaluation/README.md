# ASR Evaluation: WER & CER — Code Lab

Build a small, auditable ASR Evaluation: WER & CER example, inspect the key state, and verify a correctness invariant with assertions.
