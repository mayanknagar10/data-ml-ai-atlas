# RL Fundamentals: Agent, Environment, State, Action & Reward — Code Lab

Build a small, auditable RL Fundamentals: Agent, Environment, State, Action & Reward example, inspect the key state, and verify a correctness invariant with assertions.
