# Hybrid Lexical + Vector Retrieval — Code Lab

Build lexical and vector rankings, fuse them with RRF, and verify scale invariance, candidate union, deduplication and complementary retrieval.
