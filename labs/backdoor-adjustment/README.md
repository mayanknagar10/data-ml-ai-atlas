# Backdoor Adjustment & Confounding Control — Code Lab

Estimate a known confounded treatment effect with g-computation and inverse weighting and verify the naive contrast remains biased.
