# Censoring, Survival & Hazard Functions — Code Lab

Compute discrete survival, hazard, and cumulative hazard and compare a continuous exponential model with SciPy while verifying algebraic and monotonicity invariants.
