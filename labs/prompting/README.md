# Prompt Engineering — Code Lab

Build a small, auditable Prompt Engineering example, inspect the key state, and verify a correctness invariant with assertions.
