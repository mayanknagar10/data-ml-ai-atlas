# Bayesian Networks & d-Separation — Code Lab

Build a small, auditable Bayesian Networks & d-Separation example, inspect the key state, and verify a correctness invariant with assertions.
