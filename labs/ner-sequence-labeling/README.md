# Named Entity Recognition & Sequence Labeling — Code Lab

Build a small, auditable Named Entity Recognition & Sequence Labeling example, inspect the key state, and verify a correctness invariant with assertions.
