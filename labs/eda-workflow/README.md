# A Systematic EDA Workflow — Code Lab

Build a small reproducible table profiler, compare key summaries with pandas, and verify grain, missingness, range, and category contracts.
