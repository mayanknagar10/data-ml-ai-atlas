# Forecast Monitoring & Retraining — Code Lab

Build a small, auditable Forecast Monitoring & Retraining example, inspect the key state, and verify a correctness invariant with assertions.
