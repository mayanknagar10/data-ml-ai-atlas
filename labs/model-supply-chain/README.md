# Model & Dependency Supply-Chain Security — Code Lab

Build a small, auditable Model & Dependency Supply-Chain Security example, inspect the key state, and verify a correctness invariant with assertions.
