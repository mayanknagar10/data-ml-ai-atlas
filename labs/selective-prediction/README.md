# Selective Prediction & Abstention — Code Lab

Build a small, auditable Selective Prediction & Abstention example, inspect the key state, and verify a correctness invariant with assertions.
