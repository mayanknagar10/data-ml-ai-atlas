# Query Plans & SQL Performance — Code Lab

Use SQLite plan output and timing to verify index eligibility, result equivalence, and the difference between selective and broad predicates.
