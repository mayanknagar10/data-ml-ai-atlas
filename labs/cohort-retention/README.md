# Cohort Retention Analysis — Code Lab

Build an exact monthly cohort-retention matrix, compare it with pandas, and verify cohort membership, maturity, uniqueness, and denominators.
