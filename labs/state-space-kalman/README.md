# State-Space Models & Kalman Filtering — Code Lab

Build a small, auditable State-Space Models & Kalman Filtering example, inspect the key state, and verify a correctness invariant with assertions.
