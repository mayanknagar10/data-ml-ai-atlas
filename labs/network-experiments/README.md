# Interference & Network Effects in Experiments — Code Lab

Simulate network spillovers, compare individual and cluster assignment, and verify contamination, contrast dilution, and cluster-aware summaries.
