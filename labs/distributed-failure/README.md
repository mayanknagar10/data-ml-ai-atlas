# Retries, Idempotency & Exactly-once Semantics — Code Lab

Build a small, auditable Retries, Idempotency & Exactly-once Semantics example, inspect the key state, and verify a correctness invariant with assertions.
