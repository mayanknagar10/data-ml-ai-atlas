# Star Schemas, Facts & Dimensions — Code Lab

Build a tiny star schema, calculate line-grain metrics, and verify uniqueness, referential coverage, and reconciliation invariants.
