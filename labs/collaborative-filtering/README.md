# User–User & Item–Item Collaborative Filtering — Code Lab

Build a small, auditable User–User & Item–Item Collaborative Filtering example, inspect the key state, and verify a correctness invariant with assertions.
