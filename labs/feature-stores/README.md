# Feature Stores: Offline vs Online — Code Lab

Build a small, auditable Feature Stores: Offline vs Online example, inspect the key state, and verify a correctness invariant with assertions.
