# Stored Procedures & Data Pipelines — Code Lab

Model an idempotent set-based partition load in SQLite and verify rerun, rollback, uniqueness, and reconciliation invariants.
