...
# ---- Verify it ----
assert abs(stage2-beta)<.03
assert abs(wald-beta)<.03 and abs(ratio-beta)<.03
assert abs(ols-beta)>.7
assert abs(stage2-ratio)<1e-12
assert first_coef>1.35 and first_r2>.25
