# Cross-Entropy & Log Loss — Code Lab

Implement stable cross-entropy from logits, compare scikit-learn log loss, and verify shift invariance, gradients and the entropy-plus-KL identity.
