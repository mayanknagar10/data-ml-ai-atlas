# Design a Rare-event Detection System — Code Lab

Build a small, auditable Design a Rare-event Detection System example, inspect the key state, and verify a correctness invariant with assertions.
