# Model Compilation: torch.compile, ONNX & TensorRT — Code Lab

Build a small, auditable Model Compilation: torch.compile, ONNX & TensorRT example, inspect the key state, and verify a correctness invariant with assertions.
