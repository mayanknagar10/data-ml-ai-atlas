# Image Preprocessing & Data Augmentation — Code Lab

Build a small, auditable Image Preprocessing & Data Augmentation example, inspect the key state, and verify a correctness invariant with assertions.
