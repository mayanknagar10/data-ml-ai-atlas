# Partitioning & Sharding — Code Lab

Build a small, auditable Partitioning & Sharding example, inspect the key state, and verify a correctness invariant with assertions.
