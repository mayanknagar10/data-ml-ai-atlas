# Workflow Orchestration — Code Lab

Build a small, auditable Workflow Orchestration example, inspect the key state, and verify a correctness invariant with assertions.
