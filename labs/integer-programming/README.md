# Integer & Mixed-Integer Optimization — Code Lab

Solve a binary knapsack by enumeration, compare it with SciPy milp, and verify domains, capacity, objective, and relaxation gap.
