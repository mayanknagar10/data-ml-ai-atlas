# Hierarchical Clustering — Code Lab

Implement agglomerative average linkage, compare a Ward cut with scikit-learn, and verify merge and partition invariants.
