# Vectors, Matrices & Dot Products — Code Lab

Implement matrix multiplication from its index definition, then verify shape, manual entries, identity, associativity and NumPy agreement.
