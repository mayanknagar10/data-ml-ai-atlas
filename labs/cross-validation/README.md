# Train/Validation/Test & Cross-validation — Code Lab

Build leakage-safe K-fold evaluation with a preprocessing pipeline, verify library agreement, and construct complete out-of-fold predictions.
