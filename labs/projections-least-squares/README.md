# Orthogonality, Projections & Least Squares — Code Lab

Project by solving least squares and verify the normal-equation, orthogonality, minimum-error and NumPy invariants.
