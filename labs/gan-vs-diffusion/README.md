# GAN vs Diffusion vs Flow Matching — Code Lab

Build a small, auditable GAN vs Diffusion vs Flow Matching example, inspect the key state, and verify a correctness invariant with assertions.
