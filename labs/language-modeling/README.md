# Language Modeling & Next-token Prediction — Code Lab

Build a small, auditable Language Modeling & Next-token Prediction example, inspect the key state, and verify a correctness invariant with assertions.
