# Vector vs Raster Spatial Data — Code Lab

Represent a raster grid and vector polygon, map cells through an affine transform, and verify masked zonal aggregation and area semantics.
