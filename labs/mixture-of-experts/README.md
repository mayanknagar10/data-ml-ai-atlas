# Mixture-of-Experts Transformers — Code Lab

Build a small, auditable Mixture-of-Experts Transformers example, inspect the key state, and verify a correctness invariant with assertions.
