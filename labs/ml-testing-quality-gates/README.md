# ML Testing & Quality Gates — Code Lab

Build a small, auditable ML Testing & Quality Gates example, inspect the key state, and verify a correctness invariant with assertions.
