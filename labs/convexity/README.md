# Convexity & Optimization Intuition — Code Lab

Implement projected gradient descent for a strongly convex box-constrained quadratic, compare with SciPy, and verify descent, feasibility, and stationarity.
