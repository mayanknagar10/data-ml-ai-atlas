# Local Outlier Factor & One-Class SVM — Code Lab

Implement Local Outlier Factor exactly, compare it with scikit-learn, and verify local-density, permutation, and One-Class SVM novelty behavior.
