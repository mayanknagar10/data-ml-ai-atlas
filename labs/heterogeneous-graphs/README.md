# Heterogeneous Graphs & Relation Types — Code Lab

Build a small, auditable Heterogeneous Graphs & Relation Types example, inspect the key state, and verify a correctness invariant with assertions.
