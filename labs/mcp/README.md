# Model Context Protocol (MCP) — Code Lab

Build a small, auditable Model Context Protocol (MCP) example, inspect the key state, and verify a correctness invariant with assertions.
