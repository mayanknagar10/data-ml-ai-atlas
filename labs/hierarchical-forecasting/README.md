# Hierarchical & Grouped Forecast Reconciliation — Code Lab

Build a small, auditable Hierarchical & Grouped Forecast Reconciliation example, inspect the key state, and verify a correctness invariant with assertions.
