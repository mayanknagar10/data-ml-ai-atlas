# Self-supervised & Contrastive Visual Representation Learning — Code Lab

Build a small, auditable Self-supervised & Contrastive Visual Representation Learning example, inspect the key state, and verify a correctness invariant with assertions.
