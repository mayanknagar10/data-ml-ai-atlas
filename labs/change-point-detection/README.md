# Change-point Detection — Code Lab

Implement exact penalized mean-shift segmentation, compare its boundary with CUSUM evidence, and verify localization, translation, constant-series, and penalty invariants.
