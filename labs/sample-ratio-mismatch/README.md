# Sample Ratio Mismatch (SRM) — Code Lab

Implement a multinomial SRM check, compare it with SciPy, and localize a treatment-specific count loss across time slices.
